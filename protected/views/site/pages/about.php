...
<div style=" margin: 0 auto">
    <img src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/fai.jpg" height="80" width="80" align="middle" ">
    <img src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/uncesp.jpg" height="80" width="80" align="middle">
    <img src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/logo_inta.png" height="80" width="80" align="middle">
</div></p>
